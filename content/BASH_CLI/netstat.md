...
SYNOPSIS
       ...
       [--verbose|-v]  [--program|-p] [--numeric|-n] [--numeric-hosts] [--nu‐
       meric-ports] [--numeric-users] [--continuous|-c]
       ...
       col={inet,inet6,unix,ipx,ax25,netrom,ddp,bluetooth,    ...     }     ]
...
NOTES
       ...
       placement  for  netstat -r is ip route.  Replacement for netstat -i is
...
OPTIONS
   ...
   --protocol=family, -A
       ...
       The address family inet (Iv4) includes raw, udp, udplite and tcp  pro‐
       tocol sockets.
...
OUTPUT
   ...
   Recv-Q
       ...
       nected to this socket.  Listening: Since  Kernel  2.6.18  this  column
...
AUTHORS
       ...
       foot.com>. The man page and the  command  included  in  the  net-tools
       package  is totally rewritten by Bernd Eckenfels <ecki@linux.de>.  UD‐
